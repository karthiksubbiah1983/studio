...
export function SidebarElement({ element }: Props) {
  ...
  return (
    <div
      ...
      className="flex flex-col items-center justify-center p-2 rounded-lg cursor-grab bg-card hover:border-primary border border-border transition-all duration-200 shadow-sm"
    >
